...
const translations: Record<Lang, Record<TranslationKey, string>> = {
  en: {
    ...
    "auth.or": "or",
    "itineraries.pageTitle": "Explore Itineraries",
    "itineraries.pageSubtitle": "Discover amazing adventures and activities across Rwanda",
    "itineraries.loading": "Loading itineraries...",
    "itineraries.noResults": "No itineraries found.",
    "itineraries.error": "Failed to load itineraries",
    "itineraries.registered": "Successfully registered!",
    "itineraries.loginRequired": "Please login to register for an itinerary.",
    "itineraries.filterAll": "All Itineraries",
    "itineraries.searchPlaceholder": "Search itineraries...",
    "detail.goBack": "Go back",
    "detail.notFound": "The requested itinerary could not be found.",
    "detail.loadingDetails": "Loading itinerary details...",
    ...
    "showcase.ctaButton": "Browse Itineraries",
    "nav.profile": "Profile",
    ...
    "admin.totalItineraries": "Total Itineraries",
    ...
    "company.dashboard.totalItineraries": "Total Itineraries",
    ...
    "company.dashboard.upcomingItineraries": "Upcoming Itineraries",
    "company.dashboard.viewAll": "View All",
    "company.dashboard.noUpcoming": "No upcoming itineraries scheduled",
    ...
    "company.createItinerary.itineraryTitle": "Itinerary Title",
    "company.createItinerary.titlePlaceholder": "e.g. Gorilla Trekking Adventure in Volcanoes Park",
    "company.createItinerary.details": "Itinerary Details",
    ...
    "company.createItinerary.creating": "Creating Itinerary...",
    "company.createItinerary.createButton": "Create Itinerary",
    "company.createItinerary.success": "Itinerary created successfully!",
