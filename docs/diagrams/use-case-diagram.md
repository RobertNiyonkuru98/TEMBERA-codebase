...
| UC12 | Create Itinerary | Add a new travel itinerary with details |
...
| UC17 | Manage Company Profile | Update company information |
...
| UC25 | View System Statistics | Access platform-wide analytics |
